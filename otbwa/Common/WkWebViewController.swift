...
class WkWebViewController: UIViewController {
    ...
    static func initWithUrl(_ url:String, _ title:String, completion:((_ data:Any?) ->Void)?) ->WkWebViewController {
        let vc = WkWebViewController.init(nibName: "WkWebViewController", bundle: nil)
        vc.strUrl = url
        vc.vcTitle = title
    ...
    override func viewDidLoad() {
        ...
        CNavigationBar.drawBack(self, nil, #selector(onClickedBtnAction(_ :)))
