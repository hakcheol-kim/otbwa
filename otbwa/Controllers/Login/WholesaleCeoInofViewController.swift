//
//  WholesaleCeoInofViewController.swift
//  otbwa
//
...
class WholesaleCeoInofViewController: BaseViewController {
    ...
    @IBAction func onClickedBtnActions(_ sender: UIButton) {
        if sender.tag == TAG_TOOL_KEYBOARD_DOWN {
            ...
            let vc = WholesaleCeoStoreInofViewController.instantiateFromStoryboard(.login)!
...
extension WholesaleCeoInofViewController: UITextFieldDelegate {
